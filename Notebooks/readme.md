...
2. **Phase 2 (Extraction)**: Zero-shot validation to clarify ambiguous Actor-Goal-Rationale extractions when BERT confidence < 0.90
3. **Phase 3 (Classification)**: Chain-of-thought reasoning to validate FR/NFR classification when NoRBERT confidence < 0.90
